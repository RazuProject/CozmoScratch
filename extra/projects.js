(function(){
  ...
  function setDefaultTab() {
    ...
    // Changed default to horizontal as of COZMO-16959
    // This is controlled in C# by the projects param in most cases
    if (!tabElem) {
      tabElem = document.querySelector('#horizontal-projects-tab');
    }
